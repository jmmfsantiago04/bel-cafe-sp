...
export function ServicesQuestions() {
        ...
        async function loadFaqs() {
            try {
                ...
                if (result.data) {
                    ...
                    setFaqs(typedFaqs.filter(faq => faq.category === "services"))
                }
            } catch (error) {
    ...
    if (isLoading) {
        return (
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6 md:p-8">
                <h2 className="text-2xl font-semibold text-[#2B4C5C] mb-6">Serviços & Facilidades</h2>
